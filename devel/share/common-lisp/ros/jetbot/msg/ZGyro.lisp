...
(cl:defmethod cl:initialize-instance :after ((m <ZGyro>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ZGyro)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbot-msg:<ZGyro> is deprecated: use jetbot-msg:ZGyro instead.")))
...
(cl:defmethod angle-val ((m <ZGyro>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbot-msg:angle-val is deprecated.  Use jetbot-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'rate-val :lambda-list '(m))
(cl:defmethod rate-val ((m <ZGyro>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbot-msg:rate-val is deprecated.  Use jetbot-msg:rate instead.")
  (rate m))
